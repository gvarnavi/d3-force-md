...
tape("forceCenter repositions nodes", function(test) {
  ...
  f.nodes([a, b, c]);
  f.tick(2);
  test.nodeEqual(a, { index: 0, x: -100, y: 0, vy: 0, vx: 0 , force_x: 0, force_y: 0, mass: 1});
  test.nodeEqual(b, { index: 1, x: 0, y: 0, vy: 0, vx: 0 , force_x: 0, force_y: 0, mass: 1});
  test.nodeEqual(c, { index: 2, x: 100, y: 0, vy: 0, vx: 0 , force_x: 0, force_y: 0, mass: 1});
  test.end();
});
